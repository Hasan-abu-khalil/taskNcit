            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            <div class="d-sm-none d-lg-inline-block">Hi , Hasan</div>
                            ...
                            <div>
                                <form method="POST" class="d-flex" action="{{ route('logout') }}">
                                    ...
                                    <button type="submit" class="dropdown-item has-icon text-danger"
                                        ...
                                        <i class="fas fa-sign-out-alt" style=" font-size: 18px;"> Logout</i>
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html">NCIT</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="index.html">NC</a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class=active><a class="nav-link" href="{{ route('admin_user.index') }}">User</a>
                                </li>
                            </ul>
                        </li>
